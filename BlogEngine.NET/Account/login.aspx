    ...
    <asp:Login ID="LoginUser" runat="server" EnableViewState="false" RenderOuterTable="false" OnAuthenticate="LoginUser_OnAuthenticate">
        <LayoutTemplate>
            ...
            <div class="account-body">
                ...
                <asp:Button ID="LoginButton" runat="server" CommandName="Login" CssClass="hidden" />
                <asp:Button ID="LoginButtonReal" runat="server" CssClass="btn btn-success btn-block btn-lg" Text="<%$Resources:labels,login %>" />
