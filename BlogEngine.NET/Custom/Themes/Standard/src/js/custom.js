$(document).ready(function () {
    ...
    //
    $("#spnCaptchaIncorrect").detach().appendTo('#commentCaptcha');
    $(".g-recaptcha").detach().appendTo('#commentCaptcha');
