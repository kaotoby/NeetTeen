...
public partial class _default : BlogEngine.Core.Web.Controls.BlogBasePage
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
        ...
        else
        {
            //if (!BlogSettings.Instance.UseBlogNameInPageTitles)
                base.SetPageTitle(BlogSettings.Instance.Name);

            //if (!string.IsNullOrEmpty(BlogSettings.Instance.Description))
            //    Page.Title += " | " + Server.HtmlEncode(BlogSettings.Instance.Description);

            base.SetMetaDescription(BlogSettings.Instance.Description);
            base.SetAbsoluteUrl(Utils.AbsoluteWebRoot.ToString());
        }
	...
	private void DisplayCategories()
	{
		if (!String.IsNullOrEmpty(Request.QueryString["id"]))
		{
            ...
            base.SetMetaDescription(string.IsNullOrWhiteSpace(category.Description) ? category.Title : category.Description);
        }
	}
