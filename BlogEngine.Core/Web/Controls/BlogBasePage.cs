...
namespace BlogEngine.Core.Web.Controls
{
    ...
    public abstract class BlogBasePage : Page
    {
        ...
        /// <summary>
        /// Add a meta property to the page's header.
        /// </summary>
        /// <param name="property">
        /// The property name.
        /// </param>
        ...
        /// The tag link href.
        /// </param>
        protected virtual void AddLink(string rel, string link) {
            if (string.IsNullOrEmpty(rel) || string.IsNullOrEmpty(link))
                return;

            const string tag = "\n\t<link rel=\"{0}\" href=\"{1}\" />";
            Header.Controls.Add(new LiteralControl(string.Format(tag, rel, link)));
        }
        ...
        /// <summary>
        /// Sets the post's description as the description metatag.
        /// </summary>
        protected void SetMetaDescription(string desc) {
            AddMetaTag("description", desc);
            AddMetaProperty("og:description", desc);
        }

        /// <summary>
        /// Adds the post's description as the description metatag.
        /// </summary>
        protected void SetAbsoluteUrl(string url) {
        ...
        /// <summary>
        /// The Open Graphic Type. <see href="https://developers.facebook.com/docs/reference/opengraph">Ref</see>
        /// </summary>
        protected virtual string OgType => "website";

        private static string _logoImage = CustomFieldsParser.CachedFields.FirstOrDefault(f => f.Key.ToLower() == "logo").Value;

        private string _ogImage = _logoImage;

        /// <summary>
        /// The image thumbnail of the page.
        /// </summary>
