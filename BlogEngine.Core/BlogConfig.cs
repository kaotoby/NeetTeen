...
namespace BlogEngine.Core
{
    ...
    public class BlogConfig
    {
        ...
        public static string ReservedBlogNames
        {
            get
            {
                return _reservedBlogNames ?? (_reservedBlogNames = WebConfigurationManager.AppSettings["BlogEngine.ReservedBlogNames"] ?? @"(account|admin|api|app_code|app_data|app_globalresources|bin|content|editors|modules|pics|scripts|setup|templates|tests|themes|user controls|widgets|post|page|category|author|tag|calendar|neet)");
            }
        }
        ...
        public static string DefaultEditor
        {
            get
            {
                return string.IsNullOrEmpty(WebConfigurationManager.AppSettings["BlogEngine.DefaultEditor"])
                    ? "~/neet/editors/tinymce/editor.cshtml"
